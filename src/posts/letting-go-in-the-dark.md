---
title: "Letting Go in the Dark: BepiColombo and the Quiet Farewell of the MTM"
description: "Watching ESA's deep-space broadcast for BepiColombo’s MTM separation—no cameras, no live views, just carrier spikes and the quiet departure of an eight-year workhorse."
date: 2026-09-04
category: Space
featured: false
draft: false
...
We have been thoroughly spoiled by modern rocketry. Four days earlier, watching the Roman Space Telescope lift off from Cape Canaveral, we were treated to high-definition cameras following Falcon Heavy through supersonic staging, crisp booster separation, and solar panel deployment relayed with the polish of a televised sporting event.
...
And the numbers, as it turned out, were flawless.
...
<span class="margin-term" tabindex="0">Solar Electric Propulsion<span class="margin-card" role="tooltip"><span class="margin-card-header"><span class="margin-card-title">Solar Electric Propulsion</span><span class="margin-card-tag">Ion Drive</span></span><span class="margin-card-body">A high-efficiency propulsion system that ionises an inert propellant gas (such as xenon) using electricity generated from solar panels, accelerating ions through an electrostatic grid at velocities up to 40 km/s. While producing tiny thrust compared to chemical rockets, it can fire continuously for months with exceptional fuel economy.</span><span class="margin-card-arrow" aria-hidden="true"></span></span></span> is what made BepiColombo possible. Reaching Mercury is counter-intuitively one of the most energetically demanding journeys in orbital mechanics. Because the spacecraft is dropping deep into the Sun’s immense gravity well, it continuously picks up speed. To enter orbit around Mercury rather than careening past it or plunging into the Sun, a spacecraft must shed a colossal amount of orbital energy.
...
- **21 November 2026**: Mercury Orbit Insertion (MOI). MPO’s onboard chemical bipropellant engines will fire to capture the combined stack into orbit around Mercury.
- **9–10 December 2026**: Orbiter Separation. MPO will release Mio and jettison the protective Magnetospheric Orbiter Sunshield and Interface Structure (MOSIF). Both spacecraft will then use dedicated thrusters to maneuver into their respective individual science orbits.
- **April 2027**: Routine science operations begin, probing Mercury’s magnetic field, exosphere, cratered crust, and oversized iron core.
